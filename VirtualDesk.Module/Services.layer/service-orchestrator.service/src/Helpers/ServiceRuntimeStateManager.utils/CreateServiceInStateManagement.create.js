...
const CreateCreateServiceInStateManagement = ({ stateManager }) => 
    (serviceId, params) => {
        ...
        const { startupParams, storageParams, socketParams, hostMountParams, ports, networkmode } = params

        SetDataProperty(SERVICE_STATE_GROUP, serviceId, "instanceParams", { serviceId, startupParams, storageParams, socketParams, hostMountParams, ports, networkmode })
