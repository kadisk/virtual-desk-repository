...
const RequestTypes = Object.freeze({
    ...
    FETCH_SOCKET_DATA_LIST          : Symbol("FETCH_SOCKET_DATA_LIST"),
    FETCH_SOCKET_PARAM_DATA_LIST    : Symbol("FETCH_SOCKET_PARAM_DATA_LIST"),
    FETCH_HOST_MOUNT_PARAM_DATA_LIST: Symbol("FETCH_HOST_MOUNT_PARAM_DATA_LIST"),
    REGISTER_STORAGE                : Symbol("REGISTER_STORAGE"),
    REGISTER_STORAGE_PARAM          : Symbol("REGISTER_STORAGE_PARAM"),
    REGISTER_SOCKET                 : Symbol("REGISTER_SOCKET"),
    REGISTER_SOCKET_PARAM           : Symbol("REGISTER_SOCKET_PARAM"),
    UPDATE_SOCKET_PARAM_SOCKET_ID   : Symbol("UPDATE_SOCKET_PARAM_SOCKET_ID"),
    REGISTER_HOST_MOUNT_PARAM       : Symbol("REGISTER_HOST_MOUNT_PARAM"),
    UPDATE_HOST_MOUNT_PARAM_HOST_MOUNT_ID : Symbol("UPDATE_HOST_MOUNT_PARAM_HOST_MOUNT_ID"),
    CREATE_NEW_VOLUME               : Symbol("CREATE_NEW_VOLUME"),
    CREATE_NEW_SOCKET_VOLUME        : Symbol("CREATE_NEW_SOCKET_VOLUME"),
