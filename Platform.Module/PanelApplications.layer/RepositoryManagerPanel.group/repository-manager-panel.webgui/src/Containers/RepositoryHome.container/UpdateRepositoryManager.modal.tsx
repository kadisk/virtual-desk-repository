...
const UpdateRepositoryManagerModal = ({
    onClose,
    namespaceId,
    namespace,
    recentRepositoryImported,
    HTTPServerManager
}) => {
    ...
    const _GetRepositoryServiceManager = () =>
        ...
        React.useEffect(() => {
            if(recentRepositoryImported?.sourceType){
                ActiveUpdateRepositoryMode()
            }
        }, [recentRepositoryImported])
        ...
        <div className="modal-dialog modal-xl" role="document">
            <div className="modal-content">
                ...
                }
                {
                    ...
                    && <div className="empty">
                            <p style={{fontSize:"1.8em"}}>Importing <strong>{namespace}</strong>...</p>
                                ...
                                <div className="col-12">
                                    <div className="mb-3">
                                        <div className="form-selectgroup">
                                            <label className="form-selectgroup-item bg-purple-lt">
                ...
                }
                {
                    ...
                    && <div className="modal-footer">
                            <button className="btn btn-link link-secondary" onClick={() => {}}>
                                Cancel
                            </button>
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdateRepositoryManagerModal)
